...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.RecordChildrenPage();
  });
  ...
  describe('RecordChildrenPage', function() {
    it('should create an instance of RecordChildrenPage', function() {
      // uncomment below and update the code to test RecordChildrenPage
      //var instance = new GraxApi.RecordChildrenPage();
      //expect(instance).to.be.a(GraxApi.RecordChildrenPage);
    });
