...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.RecordVersionsPage();
  });
  ...
  describe('RecordVersionsPage', function() {
    it('should create an instance of RecordVersionsPage', function() {
      // uncomment below and update the code to test RecordVersionsPage
      //var instance = new GraxApi.RecordVersionsPage();
      //expect(instance).to.be.a(GraxApi.RecordVersionsPage);
    });
