...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.RecordRestoredFrom();
  });
  ...
  describe('RecordRestoredFrom', function() {
    it('should create an instance of RecordRestoredFrom', function() {
      // uncomment below and update the code to test RecordRestoredFrom
      //var instance = new GraxApi.RecordRestoredFrom();
      //expect(instance).to.be.a(GraxApi.RecordRestoredFrom);
    });
