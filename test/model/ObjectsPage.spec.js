...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.ObjectsPage();
  });
  ...
  describe('ObjectsPage', function() {
    it('should create an instance of ObjectsPage', function() {
      // uncomment below and update the code to test ObjectsPage
      //var instance = new GraxApi.ObjectsPage();
      //expect(instance).to.be.a(GraxApi.ObjectsPage);
    });
