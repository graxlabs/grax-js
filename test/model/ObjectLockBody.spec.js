...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ObjectLockBody', function() {
      beforeEach(function() {
        instance = new GraxApi.ObjectLockBody();
      });

      it('should create an instance of ObjectLockBody', function() {
        // TODO: update the code to test ObjectLockBody
        expect(instance).to.be.a(GraxApi.ObjectLockBody);
      });
