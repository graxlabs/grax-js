...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ObjectUnlockBody', function() {
      beforeEach(function() {
        instance = new GraxApi.ObjectUnlockBody();
      });

      it('should create an instance of ObjectUnlockBody', function() {
        // TODO: update the code to test ObjectUnlockBody
        expect(instance).to.be.a(GraxApi.ObjectUnlockBody);
      });
