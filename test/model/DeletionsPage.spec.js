...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.DeletionsPage();
  });
  ...
  describe('DeletionsPage', function() {
    it('should create an instance of DeletionsPage', function() {
      // uncomment below and update the code to test DeletionsPage
      //var instance = new GraxApi.DeletionsPage();
      //expect(instance).to.be.a(GraxApi.DeletionsPage);
    });
