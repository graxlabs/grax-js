...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.DeletionRecordsPage();
  });
  ...
  describe('DeletionRecordsPage', function() {
    it('should create an instance of DeletionRecordsPage', function() {
      // uncomment below and update the code to test DeletionRecordsPage
      //var instance = new GraxApi.DeletionRecordsPage();
      //expect(instance).to.be.a(GraxApi.DeletionRecordsPage);
    });
