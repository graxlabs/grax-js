...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraxApi.SearchFieldFilter();
  });
  ...
  describe('SearchFieldFilter', function() {
    it('should create an instance of SearchFieldFilter', function() {
      // uncomment below and update the code to test SearchFieldFilter
      //var instance = new GraxApi.SearchFieldFilter();
      //expect(instance).to.be.a(GraxApi.SearchFieldFilter);
    });
